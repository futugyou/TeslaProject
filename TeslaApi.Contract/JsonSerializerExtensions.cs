...
namespace TeslaApi.Contract
{
    public class JsonSerializerExtensions
    {
        ...
        class CustomJsonStringEnumConverter : JsonConverterFactory
        {
        ...
        class JsonNamingPolicyDecorator : JsonNamingPolicy
        {
        ...
        class DictionaryLookupNamingPolicy : JsonNamingPolicyDecorator
        {
        ...
        class Int32NullConverter : JsonConverter<int>
        {
        ...
        class BoolNullConverter : JsonConverter<bool>
        {
        ...
        class LongNullConverter : JsonConverter<long>
        {
